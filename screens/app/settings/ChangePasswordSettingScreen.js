...
const ChangeNameSettingScreen = (props) => {
  ...
  return (
    ...
    <View style = {styles.screen}>
        ...
        <TextInput style = {styles.password} secureTextEntry={true} onChangeText = {(text) => {
          setNewPassword(text);
        }}
        placeholder = 'New Password'
        value = {newPassword}
        />
        <TextInput style = {styles.checkPassword} secureTextEntry={true} onChangeText = {(text) => {
        ...
        <View style = {{marginTop: 12}}>
            <Button title = 'Change' color = '#3fc5f0'
            onPress = {checkTwoPassword} ></Button>
        </View>
